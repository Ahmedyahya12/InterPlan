...
export const afficherDetClientUpd = async (DetaiContainer, clientId) => {
  ...
  onAuthStateChanged(auth, (user) => {
    ...
    const clientCollection = collection(db, "clients"); // Supposons que les informations des clients sont dans une collection "clients"
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    value="${client.direction || ''}" <!-- Laisser vide si la direction est non définie -->
                    required
                  />
                </div>
              </div>
